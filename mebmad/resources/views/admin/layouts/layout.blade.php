   ...
   <section class="sidebar">
     ...
     <ul class="sidebar-menu" data-widget="tree">
       ...
       <li class="active treeview">
         <a href="#">
           <i class="fa fa-dashboard"></i> <span> users controll</span>
           <span class="pull-right-container">
             <i class="fa fa-angle-left pull-right"></i>
           </span>
         </a>
         <ul class="treeview-menu">
           <li class="active"><a href="{{url('adduser')}}"><i class="fa fa-circle-o"></i> add user</a></li>
           <li><a href="{{url('user')}}"><i class="fa fa-circle-o"></i> all user</a> </li>
         </ul>

       </li>
       <li class="active treeview">
         <a href="#">
           <i class="fa fa-dashboard"></i> <span> Site Sittings</span>
           <span class="pull-right-container">
             <i class="fa fa-angle-left pull-right"></i>
           </span>
         </a>
         <ul class="treeview-menu">
           <li class="active"><a href="{{url('mainsitting')}}"><i class="fa fa-circle-o"></i> Main Sittings</a></li>
           <li><a href="{{url('user')}}"><i class="fa fa-circle-o"></i> all user</a> </li>
         </ul>
       ...
       <li class="active treeview">
         <a href="#">
           <i class="fa fa-dashboard"></i> <span> bu Sittings</span>
           <span class="pull-right-container">
             <i class="fa fa-angle-left pull-right"></i>
           </span>
         </a>
         <ul class="treeview-menu">
           <li class="active"><a href="{{url('viewbu')}}"><i class="fa fa-circle-o"></i> view</a></li>
           <li><a href="{{url('addbu')}}"><i class="fa fa-circle-o"></i> add bu</a> </li>
         </ul>
